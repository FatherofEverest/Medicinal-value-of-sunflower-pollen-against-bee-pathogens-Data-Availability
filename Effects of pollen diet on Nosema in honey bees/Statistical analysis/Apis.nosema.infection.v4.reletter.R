...
#Update 1 July 2017 : reletter post hoc significance letters; align 2-panel figure
...
Lets<-cld(Lsm.nb, method = "pairwise", Letters = letters, sort = FALSE)
Lets
...
#added space after to move down on y axis
xlabel<- "Time (d)"
x.ticklabs<- c("10", "15")
