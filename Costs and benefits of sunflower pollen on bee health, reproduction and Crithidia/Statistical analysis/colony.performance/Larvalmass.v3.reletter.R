...
#Edited 2017.06.11: bar chart and new colors
#edited 2017.07.01: resort significance letters
...
# 1      B 87.41156 19.409296 NA  49.37004  125.4531 0.01144013 0.009361468 0.01470539      a
# 2      S 20.64512  4.510479 NA  11.80474   29.4855 0.04843760 0.039752584 0.06197845      b
...
p
#Add text
P.lmass<-p + geom_text(aes(y = bthi + 0.1 * max(bthi), label = .group),
                        size = 8)
P.lmass

##Export
# setwd("C:/Users/Evan/Google Drive/Project_Sunflower/Microcolony/jess stats/colony.performance")
# ggsave("LARVALMASS.v3.reletter.pdf", height = 5, width =5)
